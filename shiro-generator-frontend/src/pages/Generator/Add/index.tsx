  ...
  return (
    <ProCard>
      {(!id || oldData) && (
        ...
        >
          <StepsForm.StepForm name="base" title="基本信息" onFinish={async () => true}>
          ...
          <StepsForm.StepForm formRef={fileFormRef} name="fileConfig" title="文件配置">
            <FileConfigForm formRef={fileFormRef} oldData={oldData} />
          </StepsForm.StepForm>
