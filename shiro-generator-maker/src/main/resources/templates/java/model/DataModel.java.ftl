...
${indent}public ${modelInfo.type} ${modelInfo.fieldName}<#if modelInfo.defaultValue??> = ${modelInfo.defaultValue?c};
</#if>
</#macro>
...
<#if modelInfo.groupKey??>
    ...
    */
    ...
    <#list modelInfo.models as models>
    <@generateModel indent="        " modelInfo=models />
    </#list>
    }
<#else>
